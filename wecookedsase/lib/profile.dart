            ...
            children: [
              ...
              StreamBuilder<Map<String, dynamic>?>(
                ...
                builder: (context, snapshot) {
                  ...
                  final points =
                      (data['points'] ?? 0).toDouble(); // ensure it's a double
                  final daysActive = data['daysActive'] ?? 0;
                  ...
                  return FCard(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildStatCard(plants.toString(), "Plants"),
                          _buildStatCard(points.round().toString(),
                              "Points"), // 👈 label changed
                          _buildStatCard(daysActive.toString(), "Days Active"),
                        ],
                      ),
                    ),
                  ).px(16.w);
